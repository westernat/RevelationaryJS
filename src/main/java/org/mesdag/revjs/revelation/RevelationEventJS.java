...
public class RevelationEventJS extends EventJS implements RevealingCallback {
    ...
    public void register(ResourceLocation advancementId, Consumer<RevBuilder> consumer) {
    ...
    @HideFromJS
    @Override
    public void trigger(Set<ResourceLocation> doneAdvancements, Set<Block> revealedBlocks, Set<Item> revealedItems, boolean isJoinPacket) {
    ...
    public interface OnRevealCallback {
        void revealing(Set<ResourceLocation> doneAdvancements, Set<Block> revealedBlocks, Set<Item> revealedItems, boolean isJoinPacket);
    }
}
